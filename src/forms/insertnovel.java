 ...
 * @author Bisma
 */
public class insertnovel extends javax.swing.JFrame {

    /**
     * Creates new form insertnovel
     */
    public insertnovel() {
        initComponents();
        shower();
...
java.io.ByteArrayOutputStream baos= new java.io.ByteArrayOutputStream();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Enter Novel Name:");
        ...
        jLabel4.setText("SELECT AUTHOR NAME:");
        getContentPane().add(jLabel4);
        jLabel4.setBounds(40, 160, 160, 30);

        jLabel5.setFont(new java.awt.Font("Khmer UI", 1, 14)); // NOI18N
        jLabel5.setText("Enter Author Discription:");
        getContentPane().add(jLabel5);
        jLabel5.setBounds(40, 210, 170, 40);
        ...
        jScrollPane1.setBounds(220, 220, 350, 140);

        jButton1.setFont(new java.awt.Font("Khmer UI", 1, 14)); // NOI18N
        jButton1.setText("INSERT");
        getContentPane().add(jButton1);
        jButton1.setBounds(130, 390, 230, 50);
        ...
        jButton3.setBounds(400, 390, 210, 50);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        admin s=new admin();
        s.setVisible(true);
      insertnovel.this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(insertnovel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new insertnovel().setVisible(true);
            }
        });
    }
